...
The **pmempool_check_initU**()/**pmempool_check_initW**() returns NULL and sets *errno*
...
The **pmempool_checkU**()/**pmempool_checkW**() returns NULL pointer when the check completes or
