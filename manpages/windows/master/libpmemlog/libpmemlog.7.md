...
When the version check performed by **pmemlog_check_versionU**()/**pmemlog_check_versionW**() is successful,
...
The string returned by **pmemlog_check_versionU**()/**pmemlog_check_versionW**() must not be modified or freed.
