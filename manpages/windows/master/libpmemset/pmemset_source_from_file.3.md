...
The **pmemset_source_from_fileU**()/**pmemset_source_from_fileW**() functions return 0 on success or
...
The **pmemset_source_from_fileU**()/**pmemset_source_from_fileW**() can fail with the following errors:
