...
>NOTE:
The alternative solution for accessing remote persistent memory is implemented by the [librpma](../rpma/) library.

See the [librpmem page](librpmem) for documentation and examples.

#### librpma

The **librpma** is a C library to simplify accessing persistent memory on remote hosts over Remote Direct Memory Access (RDMA).
