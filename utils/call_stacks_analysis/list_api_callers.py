...
PARSER.add_argument('-a', '--call-stacks', default='call_stacks.json')
PARSER.add_argument('-e', '--call-stacks-excluded', default='call_stacks_excluded.json')
...
def main():
        ...
        call_stacks = load_call_stacks_from_json(args.call_stacks)
        excluded = load_call_stacks_from_json(args.call_stacks_excluded)
        call_stacks.extend(excluded) # complete list of call stacks
        apis = []
