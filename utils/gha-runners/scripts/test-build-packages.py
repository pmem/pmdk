...
def find_missing_libraries_and_other_elements(packages_path, pmdk_path, pmdk_debuginfo_package_name, library_name_pattern):
    """
...
class TestBuildPackages(unittest.TestCase):
    ...
    def test_completeness_of_name_of_libraries_and_others(self):
        ...
        os_distro=distro.id()
        missing_elements =\
        find_missing_libraries_and_other_elements(packages_path, pmdk_path, pmdk_debuginfo_package_name,library_name_pattern)
        error_msg = linesep +\
