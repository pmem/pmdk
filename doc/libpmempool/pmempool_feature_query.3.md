...
_UWFUNCR12(int, pmempool_feature_query, *path, enum pmempool_feature feature, unsigned flags)

_UWFUNCR12(int, pmempool_feature_enable, *path, enum pmempool_feature feature, unsigned flags)

_UWFUNCR12(int, pmempool_feature_disable, *path, enum pmempool_feature feature, unsigned flags)
```
