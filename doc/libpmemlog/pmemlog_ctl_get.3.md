...
behavior of **libpmemlog** through the control (CTL) namespace.
...
required. Those two parameters together create a CTL query. The *plp* argument
...
PMEMLOG_CONF="prefault.at_open=1;prefault.at_create=1"
```
