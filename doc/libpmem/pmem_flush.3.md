...
The sementic of **pmem_deep_flush**() function is the same as
...
and always flush processor caches.
...
The behavior of **pmem_deep_drain**() function is the same as **pmem_deep_persist**(),
except that **pmem_deep_drain**() does not flush processor caches before drain from
HW buffers and write pending queue flush.
