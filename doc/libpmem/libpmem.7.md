...
Setting this environment variable to 0 forces to issue any of **CLFLUSH**,
**CLFLUSHOPT** or **CLWB** instructions even if **pmem_has_auto_flush**(3)
function returns true and eADR is supported.
