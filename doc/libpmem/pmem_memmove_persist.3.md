...
stores followed by **pmem_persist**() can be safely replaced by a single call
...
+ **PMEM_MEM_NONTEMPORAL** - Use non-temporal instructions.
  This flag is incompatible with **PMEM_MEM_TEMPORAL**.

+ **PMEM_MEM_TEMPORAL** - Use temporal instructions.
  This flag is incompatible with **PMEM_MEM_NONTEMPORAL**.

+ **PMEM_MEM_NOCACHE** - Bypass CPU caches.
  This flag is incompatible with **PMEM_MEM_CACHE**.
  On x86\_64 this is an alias for **PMEM_MEM_NONTEMPORAL**.

+ **PMEM_MEM_CACHE** - Use CPU caches.
  This flag is incompatible with **PMEM_MEM_NOCACHE**.
  On x86\_64 this is an alias for **PMEM_MEM_TEMPORAL**.

+ **PMEM_MEM_WC** - Use write combining mode.
  This flag is incompatible with **PMEM_MEM_WB**.
  On x86\_64 this is an alias for **PMEM_MEM_NONTEMPORAL**.

+ **PMEM_MEM_WB** - Use write back mode.
  This flag is incompatible with **PMEM_MEM_WC**.
  On x86\_64 this is an alias for **PMEM_MEM_TEMPORAL**.
