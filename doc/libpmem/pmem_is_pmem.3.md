...
\[*addr*, *addr*+*len*) consists of persistent memory. To detect
persistent memory correctly, the tested range has to be mapped using
function **pmem_map_file**(). The implementation of **pmem_is_pmem**()
