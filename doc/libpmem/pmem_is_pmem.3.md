...
FILE_ATTRIBUTE_COMPRESSED will be removed if the file has any. This is
a workaround for _chsize() performance issues and it used to physically
allocate space for the file. ==e==)
# SEE ALSO #
