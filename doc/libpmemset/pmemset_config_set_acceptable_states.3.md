...
in config *cfg* structure.

Acceptable part states are compared with the determined part state during the mapping
of a new part using **pmemset_map**(3) function. If determined part state is not
among acceptabled states then **pmemset_map**(3) function terminates. This feature
works only if SDS is supported.
