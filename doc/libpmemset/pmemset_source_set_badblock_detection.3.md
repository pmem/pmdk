...
**pmemset_source_set_badblock_detection**() - set bad block detection feature on/off
...
The **pmemset_source_set_badblock_detection**() set bad block detection feature to the provided
...
**PMEMSET_EVENT_BADBLOCK** event is fired, with bad block offset and size equal 0.
