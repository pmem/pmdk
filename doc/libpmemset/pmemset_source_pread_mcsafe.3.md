...
Safe manner refers to the capability to handle errors resulting from bad blocks and
returning them to the user. For details, see corresponding **libpmem2**(7) functions
**pmem2_source_pread_mcsafe**(3) and **pmem2_source_pwrite_mcsafe**(3).
