...
and **pmemset_next_part_map**(3) functions.

Optionally **pmemset_part_map**() function can take an address of a descriptor passed via *desc* pointer.
...
If an optional descriptor was provided then address and size of the part mapping are stored in
the descriptor when this function succeeds.
...
**pmemset_part_new**(3), **pmemset_first_part_map**(3), **pmemset_next_part_map**(3),
