...
- flushing memory (**pmem2_get_flush_fn**(3)), which does not guarantee immediate completeness
- draining (**pmem2_get_drain_fn**(3)), which waits for the previous flushes to complete
