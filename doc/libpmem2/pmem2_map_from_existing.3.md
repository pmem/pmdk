...
provided by the user. This function allows usage of libpmem2 api without using libpme2_map_new for mapping file. Mapping is defined by *addr* and *len*. You have to specify underlying file as a *src*, and define granularity of this mapping.
See **pmem2_config_set_required_store_granularity**(3) and **libpmem2**(7) for more details.

Function **pmem2_map_delete** for pmem2_map object created by this function will only destroy  it and it will not unmap the mapping.

# RETURN VALUE #

The **pmem2_map_new_from_existing**() function returns 0 on succeeds
