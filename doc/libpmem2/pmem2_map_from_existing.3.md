...
provided by the user. This function allows usage of libpmem2 api without using libpme2_map_new for mapping file.
...
**pmem2_source_from_fd**(3), **pmem2_map_delete**(3),
