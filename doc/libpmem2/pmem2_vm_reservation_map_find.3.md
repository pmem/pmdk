...
by *reserv_offset* and *len* variables. It passes an address to the found mapping
via user provided *pmem2_map* pointer variable on success, otherwise it returns
*NULL* value when any mapping wasn't found.

# RETURN VALUE #

The **pmem2_vm_reservation_map_find**() returns 0 on success or a negative error
code on failure.

# ERRORS #

**pmemset_config_new**() can fail with the following errors:
