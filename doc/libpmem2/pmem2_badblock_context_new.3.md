...
pmem2_badblock_context_new and pmem2_badblock_context_delete)
...
**pmem2_badblock_clear**()) and returns it through the pointer in *\*bbctx*.
...
that is either inaccessible or unwritable due to a permanent physical damage.
