...
The **pmem2_badblock_next**() function returns 0 on success or a negative error code on failure.
...
* **PMEM2_E_NO_BAD_BLOCK_FOUND** - there are no more bad blocks for the given bad block context *\*bbctx*.
