...
The basic example is described in detail on [pmem.io](https://pmem.io/pmdk/libpmem2/).
It uses **libpmem2** to flush changes made to raw, memory-mapped persistent memory.
