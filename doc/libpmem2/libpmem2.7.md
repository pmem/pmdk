...
*power-fail protected domain* by data. Depending on the platform
capabilities, data can be persisted differently.
...
*ADR power-fail protected domain* toCPU caches. This means cache flush
