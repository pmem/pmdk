...
**pmem2_config_set_address**() - set address among with address flag in the
...
which will be used for mapping. It takes one flag only. *\*config* should be already
initialized, please see **pmem2_config_new**(3) for details. The *\*addr* cannot be **NULL**
and must be a multiple of the alignment required for the data source which will be used for
...
* **PMEM2_E_INVALID_ADDRESS_FLAG** - set flag is invalid.
