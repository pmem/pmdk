...
The **pmem2_config_new**() function allocates *pmem2_config*, and places it in *\*cfg*. 
...
The **pmem2_config_new**() function returns 0 on success or one of error values listed in the next section. 
**pmem2_config_new**() does set *\*cfg* to NULL on failure.

The **pmem2_config_delete**() function returns 0.

# ERRORS #
- **PMEM2_E_NOMEM** Out of memory.
- **PMEM2_E_EXTERNAL** in case of other errors. Please use an operating system specific
method to get more details (**GetLastError**() on Windows and **errno** everywhere else)
