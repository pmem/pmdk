...
**pmem2_config_get_alignment**() - query a alignment
...
The **pmem2_config_get_alignment**() function retrieves the alignment from file
pointed by file descriptor in the *config* for Linux or retrives the alignment
from the system info for Windows. Alignment is put in *\*alignment*.

This function is a portable replacement for OS-specific APIs.
On Linux, it hides the quirkiness of Device DAX alignment detection.
