...
If the function failed the variable pointed by *map_ptr* won't change its value
and appropriate error value will be returned. For a list of possible return
