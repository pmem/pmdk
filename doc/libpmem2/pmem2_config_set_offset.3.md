...
*\offset* must be a multiple of system's memory allocation granularity. This is needed
for **pmem2_map**(3) to succeed. To retrive **PAGESIZE** or system's memory allocation
granularity please see **pmem2_config_get_alignment**(3).
