...
virtual memory reservation that is made basing on the pmem2_vm_reservation structure
...
For the function to succeed, the *addr* must be either aligned to pagesize, or be a NULL,
the size has to be aligned to pagesize.
