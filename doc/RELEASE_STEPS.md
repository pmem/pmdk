...
- go to [GitHub's releases tab](https://github.com/pmem/pmdk/releases/new) and fill in the form:
  ...
  - upload pmdk-$VERSION.tar.gz and pmdk-$VERSION.tar.gz.asc (as an attachment)
...
To understand what the GIT_VERSION file is, please see, e.g., the message of `b3f0821dc41c4d2067a07b1545f32501fb9bb25a` commit .
