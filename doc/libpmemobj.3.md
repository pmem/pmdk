...
- KiB, MiB, GiB, ..., K, M, G, ... - (multiplier by 1024). The minimum file size of each part of the pool set is defined in **\<libpmem.h\>**
as **PMEM_MIN_PART**. The net pool size of the pool set is equal to:
