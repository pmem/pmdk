...
On success, **pmemobj_tx_xpublish**() returns 0, otherwise,
when the **POBJ_XPUBLISH_NO_ABORT** flag is enabled the error number is returned.
When *flag* is disabled the transaction is aborted, the stage is changed to
