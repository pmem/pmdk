...
+ **POBJ_XPUBLISH_NO_ABORT** - if the function ends incorrectly,
...
On success, **pmemobj_tx_xpublish**() returns 0, otherwise, the stage is changed
to **TX_STAGE_ONABORT**, **errno** is set appropriately and transaction is aborted,
when **POBJ_XPUBLISH_NO_ABORT** flag is set error number is returned.
