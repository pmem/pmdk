...
**TX_STAGE_WORK** it returns a handle to the newly allocated object. Otherwise,
the stage is set to **TX_STAGE_ONABORT**, *errno* is set appropriately and
transaction is aborted. When the **POBJ_XALLOC_NO_ABORT** flag is set
...
object. Otherwise, the stage is set to **TX_STAGE_ONABORT**, *errno*
is set appropriately and transaction is aborted. When the **POBJ_XALLOC_NO_ABORT**
flag is set **OID_NULL** is returned
...
*errno* is set appropriately and transaction is aborted. When
the **POBJ_XALLOC_NO_ABORT** flag is set **OID_NULL** is returned
...
returns 0. Otherwise, the stage is set to **TX_STAGE_ONABORT**, *errno* is set
appropriately and transaction is aborted. When the **POBJ_XFREE_NO_ABORT** flag
is set error number is returned
