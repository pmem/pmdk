...
to that objects are atomically updated.
...
even in presence of failures, all pointers to the object will either point
...
can be non-zero, even if **pmemobj_defrag**() return value indicated failure.
