...
is aborted or interrupted. And they have no information about other changes
made by transactional API. Hence, if in a single transaction the same data
is modified using transactional and then non-transactional API, transaction abort
