...
While **setjmp** macro is not used and any function in transaction fails,
...
+ **POBJ_XLOCK_NO_ABORT** - if the function ends incorrectly,
...
added to the transaction. Otherwise, the stage is changed to *TX_STAGE_ONABORT*,
*errno* is set appropriately and transaction is aborted, when **POBJ_XLOCK_NO_ABORT**
...
the stage is changed to *TX_STAGE_ONABORT*, *errno* is set appropriately
and transaction is aborted, when **POBJ_XLOCK_NO_ABORT** flag is set
