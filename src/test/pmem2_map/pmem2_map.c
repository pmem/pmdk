...
/*
 * test_map_prot_rw_mode_max_prot -- test R/W protection
 */
static int
test_map_prot_rw_mode_max_prot(const struct test_case *tc,
		int argc, char *argv[])
{
	if (argc < 2)
		UT_FATAL("usage: test_map_prot <file> <size>");
...
/*
 * test_map_prot_r_mode_max_prot -- test R/W protection
 */
static int
test_map_prot_r_mode_max_prot(const struct test_case *tc,
		int argc, char *argv[])
{
	if (argc < 2)
		UT_FATAL("usage: test_map_prot <file> <size>");
...
/*
 * test_map_prot_rw_mode_none_prot -- test R/W protection
 */
static int
test_map_prot_rw_mode_none_prot(const struct test_case *tc,
		int argc, char *argv[])
{
	if (argc < 2)
		UT_FATAL("usage: test_map_prot <file> <size>");
