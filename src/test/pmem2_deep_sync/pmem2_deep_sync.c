 ...
 * or mocked:
 * - os_open (to prevent opening non existing /sys/region[0-9]+/deep_flush
 * files)
 * - write (for counting writes to non-existing /sys/region[0-9]+/deep_flush
 * files)
 *
...
#ifndef _WIN32
#define FD_MOCK 999
#define REG_ID_MOCK 888
#define BUS_DEVICE_PATH "/sys/bus/nd/devices/region888/deep_flush"
