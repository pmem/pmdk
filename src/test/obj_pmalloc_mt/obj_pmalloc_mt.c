...
main(int argc, char *argv[])
{
	...
	run_workers(alloc_worker, Threads, args1);
	run_workers(realloc_worker, Threads, args1);
	run_workers(free_worker, Threads, args1);
	run_workers(mix_worker, Threads, args1);
	run_workers(alloc_free_worker, Threads, args1);
