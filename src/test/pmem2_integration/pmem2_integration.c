...
/*
 * test_source_anon -- test_source_anon
 */
static int
test_source_anon(const struct test_case *tc, int argc, char *argv[])
{
	...
	UT_ASSERTeq(pmem2_source_from_anon(&src), 0);
	...
	UT_ASSERTeq(pmem2_deep_sync(map, addr, alignment), PMEM2_E_NOSUPP);
