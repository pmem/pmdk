...
class TEST11(Pmem2ConfigNoDir):
    """
    setting uninitialized addr when request type PMEM2_ADDRESS_FIXED_NOREPLACE
    is used
    """
...
class TEST12(Pmem2ConfigNoDir):
    """
    setting uninitialized addr when request type PMEM2_ADDRESS_HINT is used
    """
...
class TEST13(Pmem2ConfigNoDir):
    """
    setting initialized addr when request type PMEM2_ADDRESS_HINT is used
    """
