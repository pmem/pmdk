...
def add_params(name, values, str_func=None):
    ...
    a single test parameter value as an argument and returns a string.
    The returned string is visible during execution in the test context line.
    If no str_func is provided, the underlying str() value of the parameter
