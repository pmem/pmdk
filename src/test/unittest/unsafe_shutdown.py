...
if sys.platform == 'win32':
    ...
    def _get_dimms_from_disk_no(disk_no):
        """
        Get IDs of device's underlying dimms using powershell cmndlets.
        Device is identified with a provided disk number.
        """
        ...
        if not dimms_out:
            raise futils.Fail('Disk with number {} has no underlying DIMMs'
                              .format(disk_no))
