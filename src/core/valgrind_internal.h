...
#define PMEM2_API_START()\
	if (Pmreorder_emit)\
		pmem2_emit_log(__func__, 0);
#define PMEM2_API_END()\
	if (Pmreorder_emit)\
		pmem2_emit_log(__func__, 1);
...
#define PMEM2_API_START() do {} while (0)

#define PMEM2_API_END() do {} while (0)
