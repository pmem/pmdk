 ...
 */
int
pmemobj_log_set_threshold(enum pmemobj_log_threshold threshold, enum pmemobj_log_level level)
{
        return core_log_set_threshold((enum core_log_threshold)threshold, (enum core_log_level)level);
}
 ...
 */
int
pmemobj_log_get_threshold(enum pmemobj_log_threshold threshold, enum pmemobj_log_level *level)
{
        return core_log_get_threshold((enum core_log_threshold)threshold, (enum core_log_level *)level);
}
