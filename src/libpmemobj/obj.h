...
struct pmemobjpool {
	 ...
	 * for consistency with Linux, only the pointer to the lock is embedded
	 * in the pmem-resident object. **libpmemobj**(7) transparently manages
	 * freeing of the locks when the pool is closed.
	 */
