...
/*
 * region_namespace -- returns the region
 *                           (and optionally the namespace)
 *                           where the given file is located
 */
int
region_namespace(struct ndctl_ctx *ctx, const os_stat_t *st,
...
/*
 * devdax_region_get_id -- returns the region id
 */
int
devdax_get_region_id(const os_stat_t *st, unsigned *region_id)
{
	LOG(3, "st %p region_id %u", st, *region_id);
