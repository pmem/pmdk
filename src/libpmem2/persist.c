...
{
	if (!memcmp("pmem2_memmove_nonpmem", func, strlen(func)) ||
		!memcmp("pmem2_memmove_eadr", func, strlen(func)))
		func = "pmem2_memmove";
	else if (!memcmp("pmem2_memset_nonpmem", func, strlen(func)) ||
		!memcmp("pmem2_memset_eadr", func, strlen(func)))
		func = "pmem2_memset";
