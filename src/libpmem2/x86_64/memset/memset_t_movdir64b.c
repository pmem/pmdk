...
static force_inline void
memset_mov_movdir64b(char *dest, int c, size_t len,
		flush_fn flush, flush64b_fn flush64b)
{
	__m512i zmm = _mm512_set1_epi8((char)c);
	/* See comment in memset_movnt_movdir64b */
...
memset_mov_movdir64b_noflush(char *dest, int c, size_t len)
{
	...
	memset_mov_movdir64b(dest, c, len, noflush, noflush64b);
}
...
memset_mov_movdir64b_empty(char *dest, int c, size_t len)
{
	...
	memset_mov_movdir64b(dest, c, len, flush_empty_nolog, flush64b_empty);
}
...
memset_mov_movdir64b_clflush(char *dest, int c, size_t len)
{
	...
	memset_mov_movdir64b(dest, c, len, flush_clflush_nolog, pmem_clflush);
}
...
memset_mov_movdir64b_clflushopt(char *dest, int c, size_t len)
{
	...
	memset_mov_movdir64b(dest, c, len, flush_clflushopt_nolog,
			pmem_clflushopt);
}
...
memset_mov_movdir64b_clwb(char *dest, int c, size_t len)
{
	...
	memset_mov_movdir64b(dest, c, len, flush_clwb_nolog, pmem_clwb);
}
