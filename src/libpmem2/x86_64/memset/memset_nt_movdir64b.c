...
static force_inline void
memset_movnt32x64b(char *dest, const char *src)
{
	movdir64b(dest, src);
	movdir64b(dest + 1 * 64, src);
	movdir64b(dest + 2 * 64, src);
	movdir64b(dest + 3 * 64, src);
	movdir64b(dest + 4 * 64, src);
	movdir64b(dest + 5 * 64, src);
	movdir64b(dest + 6 * 64, src);
	movdir64b(dest + 7 * 64, src);
	movdir64b(dest + 8 * 64, src);
	movdir64b(dest + 9 * 64, src);
	movdir64b(dest + 10 * 64, src);
	movdir64b(dest + 11 * 64, src);
	movdir64b(dest + 12 * 64, src);
	movdir64b(dest + 13 * 64, src);
	movdir64b(dest + 14 * 64, src);
	movdir64b(dest + 15 * 64, src);
	movdir64b(dest + 16 * 64, src);
	movdir64b(dest + 17 * 64, src);
	movdir64b(dest + 18 * 64, src);
	movdir64b(dest + 19 * 64, src);
	movdir64b(dest + 20 * 64, src);
	movdir64b(dest + 21 * 64, src);
	movdir64b(dest + 22 * 64, src);
	movdir64b(dest + 23 * 64, src);
	movdir64b(dest + 24 * 64, src);
	movdir64b(dest + 25 * 64, src);
	movdir64b(dest + 26 * 64, src);
	movdir64b(dest + 27 * 64, src);
	movdir64b(dest + 28 * 64, src);
	movdir64b(dest + 29 * 64, src);
	movdir64b(dest + 30 * 64, src);
	movdir64b(dest + 31 * 64, src);
}

static force_inline void
memset_movnt16x64b(char *dest, const char *src)
{
	movdir64b(dest, src);
	movdir64b(dest + 1 * 64, src);
	movdir64b(dest + 2 * 64, src);
...
static force_inline void
memset_movnt8x64b(char *dest, const char *src)
{
	movdir64b(dest, src);
	movdir64b(dest + 1 * 64, src);
	movdir64b(dest + 2 * 64, src);
...
static force_inline void
memset_movnt4x64b(char *dest, const char *src)
{
	movdir64b(dest, src);
	movdir64b(dest + 1 * 64, src);
	movdir64b(dest + 2 * 64, src);
...
static force_inline void
memset_movnt2x64b(char *dest, const char *src)
{
	movdir64b(dest, src);
	movdir64b(dest + 1 * 64, src);
}
...
static force_inline void
memset_movnt1x64b(char *dest, const char *src)
{
	movdir64b(dest, src);
}
		...
		barrier_fn barrier)
{
	...
	while (len >= 32 * 64) {
		memset_movnt32x64b(dest, (char *)&zmm);
		dest += 32 * 64;
		len -= 32 * 64;
	}

	if (len >= 16 * 64) {
		memset_movnt16x64b(dest, (char *)&zmm);
		dest += 16 * 64;
		len -= 16 * 64;
	}

	if (len >= 8 * 64) {
		memset_movnt8x64b(dest, (char *)&zmm);
		dest += 8 * 64;
		len -= 8 * 64;
	}

	if (len >= 4 * 64) {
		memset_movnt4x64b(dest, (char *)&zmm);
		dest += 4 * 64;
		len -= 4 * 64;
	}

	if (len >= 2 * 64) {
		memset_movnt2x64b(dest, (char *)&zmm);
		dest += 2 * 64;
		len -= 2 * 64;
	}

	if (len >= 1 * 64) {
		memset_movnt1x64b(dest, (char *)&zmm);
