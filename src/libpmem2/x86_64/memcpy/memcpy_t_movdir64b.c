...
static force_inline void
memmove_mov_movdir64b_fw(char *dest, const char *src, size_t len,
...
static force_inline void
memmove_mov_movdir64b_bw(char *dest, const char *src, size_t len,
		flush_fn flush, flush64b_fn flush64b)
{
	dest += len;
	src += len;
	...
	if (len)
		memmove_small_movdir64b(dest - len, src - len, len, flush);
}

static force_inline void
memmove_mov_movdir64b(char *dest, const char *src, size_t len,
		flush_fn flush, flush64b_fn flush64b)
{
	if ((uintptr_t)dest - (uintptr_t)src >= len)
		memmove_mov_movdir64b_fw(dest, src, len, flush, flush64b);
	else
		memmove_mov_movdir64b_bw(dest, src, len, flush, flush64b);
...
memmove_mov_movdir64b_noflush(char *dest, const char *src, size_t len)
{
	...
	memmove_mov_movdir64b(dest, src, len, noflush, noflush64b);
}
...
memmove_mov_movdir64b_empty(char *dest, const char *src, size_t len)
{
	...
	memmove_mov_movdir64b(dest, src, len, flush_empty_nolog,
			flush64b_empty);
}
...
memmove_mov_movdir64b_clflush(char *dest, const char *src, size_t len)
{
	...
	memmove_mov_movdir64b(dest, src, len, flush_clflush_nolog,
			pmem_clflush);
}
...
memmove_mov_movdir64b_clflushopt(char *dest, const char *src, size_t len)
{
	...
	memmove_mov_movdir64b(dest, src, len, flush_clflushopt_nolog,
			pmem_clflushopt);
}
...
memmove_mov_movdir64b_clwb(char *dest, const char *src, size_t len)
{
	...
	memmove_mov_movdir64b(dest, src, len, flush_clwb_nolog, pmem_clwb);
}
