...
{
	movdir64b(dest, src);
	movdir64b(dest + 1 * 64, src + 1 * 64);
	movdir64b(dest + 2 * 64, src + 2 * 64);
	movdir64b(dest + 3 * 64, src + 3 * 64);
	movdir64b(dest + 4 * 64, src + 4 * 64);
	movdir64b(dest + 5 * 64, src + 5 * 64);
	movdir64b(dest + 6 * 64, src + 6 * 64);
	movdir64b(dest + 7 * 64, src + 7 * 64);
	movdir64b(dest + 8 * 64, src + 8 * 64);
	movdir64b(dest + 9 * 64, src + 9 * 64);
	movdir64b(dest + 10 * 64, src + 10 * 64);
	movdir64b(dest + 11 * 64, src + 11 * 64);
	movdir64b(dest + 12 * 64, src + 12 * 64);
	movdir64b(dest + 13 * 64, src + 13 * 64);
	movdir64b(dest + 14 * 64, src + 14 * 64);
	movdir64b(dest + 15 * 64, src + 15 * 64);
	movdir64b(dest + 16 * 64, src + 16 * 64);
	movdir64b(dest + 17 * 64, src + 17 * 64);
	movdir64b(dest + 18 * 64, src + 18 * 64);
	movdir64b(dest + 19 * 64, src + 19 * 64);
	movdir64b(dest + 20 * 64, src + 20 * 64);
	movdir64b(dest + 21 * 64, src + 21 * 64);
	movdir64b(dest + 22 * 64, src + 22 * 64);
	movdir64b(dest + 23 * 64, src + 23 * 64);
	movdir64b(dest + 24 * 64, src + 24 * 64);
	movdir64b(dest + 25 * 64, src + 25 * 64);
	movdir64b(dest + 26 * 64, src + 26 * 64);
	movdir64b(dest + 27 * 64, src + 27 * 64);
	movdir64b(dest + 28 * 64, src + 28 * 64);
	movdir64b(dest + 29 * 64, src + 29 * 64);
	movdir64b(dest + 30 * 64, src + 30 * 64);
	movdir64b(dest + 31 * 64, src + 31 * 64);
}
