 ...
 */
static int
device_info_write(struct device_info *di_old, struct device_info *di_new,
	struct pmem2_map *map)
{
	int ret = 0;
 ...
 */
static bool
device_info_is_initalized(struct device_info *di_old,
 ...
 * was incrementeed since the last open.
 * Otherwise, the function returns true.
 */
static bool
device_info_is_consistent(struct device_info *di_old,
	struct device_info *di_new)
{
...
main(int argc, char *argv[])
{
	...
	size_t max_str_size = size - sizeof(data->persistent);
