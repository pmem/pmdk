 ...
 */
int
pmemset_map(struct pmemset_map_config *map_cfg,
		struct pmemset_extras *extra,
		struct pmemset_part_descriptor *desc)
{
	LOG(3, "map_cfg %p extra %p desc %p", map_cfg, extra, desc);
	PMEMSET_ERR_CLR();
	...
	struct pmemset_file *part_file = pmemset_map_config_get_file(map_cfg);
