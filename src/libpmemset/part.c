...
/*
 * validate_source_file - check the validity of source created from file
 */
static int
validate_source_file(struct pmemset_source *src)
{
	char *filepath;
...
/*
 * validate_source_pmem2 - check the validity of source created from
 *                         pmem2 source
 */
static int
validate_source_pmem2(struct pmemset_source *src)
{
...
static int (*validate_source[MAX_PMEMSET_SOURCE_TYPE + 1])
	(struct pmemset_source *src) =
		{ NULL, validate_source_pmem2, validate_source_file, NULL };
