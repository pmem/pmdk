		...
		struct pmem2_map *p2map)
{
	...
	/*
	 * SDS records are created for every new pmem2 mapping, those records
	 * reference SDS, source and pmem2 mapping
	 */
	sds->refcount += 1;
...
{
	struct pmemset_sds *sds = pmemset_source_get_extras(src).in_sds;
