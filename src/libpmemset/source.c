 ...
 */
int
pmemset_source_from_file(struct pmemset_source **source, const char *file)
{
	return PMEMSET_E_NOSUPP;
}
 ...
 */
int
pmemset_source_from_temporary(struct pmemset_source **source, const char *dir)
{
	return PMEMSET_E_NOSUPP;
}
#else
 ...
 */
int
pmemset_source_from_fileU(struct pmemset_source **source, const char *file)
{
	return PMEMSET_E_NOSUPP;
}
 ...
 */
pmemset_source_from_fileW(struct pmemset_source **source,
		const wchar_t *file)
{
	return PMEMSET_E_NOSUPP;
}
 ...
 */
int
pmemset_source_from_file_paramsU(struct pmemset_source **source,
		const wchar_t *file)
{
	return PMEMSET_E_NOSUPP;
}
 ...
 */
int
pmemset_source_from_file_paramsW(struct pmemset_source **source,
		const wchar_t *file)
{
	return PMEMSET_E_NOSUPP;
}
 ...
 */
int
pmemset_source_from_temporaryU(struct pmemset_source **source,
		const char *dir)
{
	return PMEMSET_E_NOSUPP;
}
 ...
 */
int
pmemset_source_from_temporaryW(struct pmemset_source **source,
		const wchar_t *dir)
{
	return PMEMSET_E_NOSUPP;
}
