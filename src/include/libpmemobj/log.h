 ...
 *   function completions e.g. connection established
 ...
 *
 * RETURN VALUE
 * pmemobj_log_set_threshold() function returns 0 on success or a negative error
 * code on failure.
 *
 * ERRORS
 * pmemobj_log_set_threshold() can fail with the following errors:
 * - E_INVAL - threshold is not PMEMOBJ_LOG_THRESHOLD nor
 *   PMEMOBJ_LOG_THRESHOLD_AUX
 ...
 *
 * RETURN VALUE
 * pmemobj_log_get_threshold() function returns 0 on success or a negative error
 * code on failure.
 *
 * ERRORS
