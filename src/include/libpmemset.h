...
#define PMEMSET_E_MAP_LENGTH_UNSET			(-200016)
#define PMEMSET_E_PART_NOT_FOUND			(-200017)
#define PMEMSET_E_INVALID_COALESCING_VALUE		(-200018)
#define PMEMSET_E_DEEP_FLUSH_FAIL			(-200019)
#define PMEMSET_E_INVALID_SOURCE_FILE_CREATE_FLAGS	(-200020)
#define PMEMSET_E_CANNOT_CREATE_TEMP_FILE		(-200021)
#define PMEMSET_E_CANNOT_GROW_SOURCE_FILE		(-200022)
#define PMEMSET_E_SOURCE_FILE_IS_EMPTY		    (-200023)
#define PMEMSET_E_PART_MAP_POSSIBLE_USE_AFTER_DROP	(-200024)
#define PMEMSET_E_CANNOT_FIT_PART_MAP			(-200025)
#define PMEMSET_E_OFFSET_OUT_OF_RANGE			(-200026)
#define PMEMSET_E_INVALID_PART_STATES			(-200027)
#define PMEMSET_E_UNDESIRABLE_PART_STATE		(-200028)
#define PMEMSET_E_SDS_ALREADY_SET			(-200029)
#define PMEMSET_E_SDS_ENOSUPP				(-200030)
#define PMEMSET_E_SDS_DEVICE_ID_LEN_TOO_BIG		(-200031)
