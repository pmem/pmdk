...
#define PMEMSET_SOURCE_FILE_CREATE_ALWAYS		(1UL << 0)
#define PMEMSET_SOURCE_FILE_CREATE_IF_NEEDED		(1UL << 1)
#define PMEMSET_SOURCE_FILE_TRUNCATE_IF_NEEDED		(1UL << 2)

#define FILE_CRATE_MODE_FROM_FLAG(flag) ((uint32_t)((flag) >> 32))
