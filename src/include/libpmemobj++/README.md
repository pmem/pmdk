...
### Standard notice ###
Please note that the C++11 standard, section 6.8, states that a valid non-POD
object must be properly constructed in the lifetime of the application.
...
practially speaking implementation defined. The only exception to this rule is
