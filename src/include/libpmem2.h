...
#define PMEM2_E_BAD_BLOCKS_NOT_CLEARED		(-100031)
#define PMEM2_E_NDCTL_NEW_CMD_FAILED		(-100032)
#define PMEM2_E_NDCTL_CMD_SUBMIT_FAILED		(-100033)
#define PMEM2_E_NDCTL_CMD_GET_RANGE_FAILED	(-100034)
