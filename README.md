...
[Join the discussion in Google Groups](http://groups.google.com/group/pmem)
...
6. [Building PMDK on Windows](#building-pmdk-on-windows)
	* [Testing Libraries](#testing-libraries-on-windows)
4. [Getting Started](#getting-started)
5. [Experimental Packages](#experimental-packages)
...
Currently these libraries only work on 640bit Linux, Windows<sup>2</sup>, and 64-bit FreeBSD 11+<sup>3</sup>.
...
The PMDK libraries support standard Valgrind drd, Helgrind and Memcheck, as well as a PM-aware version of [Valgrind](https://github.com/pmem/valgrind) (not yet available for FreeBSD). By default, support for all tools is enabled. If you wish to disable it,
