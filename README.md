...
Currently these libraries only work on 64-bit Linux and 64-bit FreeBSD 11+<sup>1</sup>.
...
><sup>1</sup> DAX is not yet supported in FreeBSD, so at this time PMDK is available as a technical preview release for development purposes.
...
><sup>2</sup> The pkg version of ncurses is required for proper operation; the base version included in FreeBSD is not sufficient.
