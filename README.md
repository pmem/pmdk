...
After successful completion of all of the above steps, libraries are ready to
include and be used in Visual Studio, no additional configuration is required.
